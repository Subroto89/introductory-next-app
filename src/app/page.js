...
export default function Home() {
  return (
    <>
      <main className="flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-gray-700 text-white">
        <div className="min-h-screen">
          ...
          <div className="text-center max-w-3xl space-y-6">
            <p className="text-xl sm:text-xl md:text-2xl font-light leading-relaxed w-full h-full">
              ...
              computing components, and essential accessories. Our mission is to
              provide you with the technology you need to innovate, create, and
